...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['update_maintenance'])) {
        ...
        if (mysqli_query($conn, $updateMaintenanceMode) && mysqli_query($conn, $updateMaintenanceMessage)) {
            ...
            $errorMessage = "Error updating maintenance settings: " . mysqli_error($conn);
        }
    }
}
?>
