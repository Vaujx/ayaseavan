...
$availableRooms = mysqli_fetch_assoc($availableRoomsResult)['total'];

$revenueQuery = "SELECT SUM(total_amount) as total FROM bookings WHERE status = 'confirmed' OR status = 'completed'";
$revenueResult = mysqli_query($conn, $revenueQuery);
$revenue = mysqli_fetch_assoc($revenueResult)['total'] ?? 0;

$cancellationsQuery = "SELECT COUNT(*) as total FROM bookings WHERE status = 'cancelled'";
$cancellationsResult = mysqli_query($conn, $cancellationsQuery);
$cancellations = mysqli_fetch_assoc($cancellationsResult)['total'];
